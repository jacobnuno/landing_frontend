...
<script>
import wTeamMember from '@/components/woonkly-team/WoonklyTeamMember'
      ...
      team: [
        {
          ...
          links: {
            ...
            youtube: 'https://www.youtube.com/channel/UCo3hRG_jF6lAVzOUh_UM5Sg',
            linkedin: 'https://mx.linkedin.com/in/danielsantos3'
          }
        },
        {
          name: 'Matei Antohi',
